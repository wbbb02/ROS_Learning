...
(cl:in-package plumbing_server_and_client-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Addints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_server_and_client-srv:<Addints-request> is deprecated: use plumbing_server_and_client-srv:Addints-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_server_and_client-srv:num1-val is deprecated.  Use plumbing_server_and_client-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_server_and_client-srv:num2-val is deprecated.  Use plumbing_server_and_client-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Addints-request>)))
  ...
  "plumbing_server_and_client/AddintsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Addints-request)))
  "Returns string type for a service object of type 'Addints-request"
  "plumbing_server_and_client/AddintsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Addints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_server_and_client-srv:<Addints-response> is deprecated: use plumbing_server_and_client-srv:Addints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <Addints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_server_and_client-srv:sum-val is deprecated.  Use plumbing_server_and_client-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Addints-response>)))
  ...
  "plumbing_server_and_client/AddintsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Addints-response)))
  "Returns string type for a service object of type 'Addints-response"
  "plumbing_server_and_client/AddintsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Addints)))
  ...
  "plumbing_server_and_client/Addints")