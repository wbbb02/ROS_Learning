...
(cl:in-package plumbing_publisher_subscriber-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_publisher_subscriber-msg:<Person> is deprecated: use plumbing_publisher_subscriber-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_publisher_subscriber-msg:name-val is deprecated.  Use plumbing_publisher_subscriber-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_publisher_subscriber-msg:age-val is deprecated.  Use plumbing_publisher_subscriber-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_publisher_subscriber-msg:height-val is deprecated.  Use plumbing_publisher_subscriber-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Person>)))
  ...
  "plumbing_publisher_subscriber/Person")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Person)))
  "Returns string type for a message object of type 'Person"
  "plumbing_publisher_subscriber/Person")
