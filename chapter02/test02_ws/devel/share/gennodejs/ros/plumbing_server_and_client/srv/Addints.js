...
// (in-package plumbing_server_and_client.srv)
...
class AddintsRequest {
  ...
  static datatype() {
    ...
    return 'plumbing_server_and_client/AddintsRequest';
  }
...
class AddintsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_server_and_client/AddintsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'plumbing_server_and_client/Addints'; }
};
